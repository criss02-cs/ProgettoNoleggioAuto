...
public class FrameClienti extends javax.swing.JFrame {
    ...
    private void caricaJTable(){
        ...
        for (Cliente object : clienti) {
            ...
            riga[2] = object.getCognome();
            riga[3] = new SimpleDateFormat("dd-MM-yyy").format(object.getDataN());
            riga[4] = object.getnPatente();
            dtm.addRow(riga);
        }
    }
    ...
    private void initComponents() {
        ...
        tblClienti.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Cliente", "Nome", "Cognome", "Data Nascita", "Numero Patente"
            }
        ) {
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtCognome, javax.swing.GroupLayout.DEFAULT_SIZE, 235, Short.MAX_VALUE)
